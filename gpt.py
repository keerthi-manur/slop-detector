"""
Train ChatGPT Detector
Binary classifier: ChatGPT (label=1) vs Human (label=0)
Saves best model to models/detector_chatgpt/
"""
...
DATA_DIR   = "data"
SAVE_PATH  = "models/detector_chatgpt"
MAX_LEN    = 256
BATCH_SIZE = 8
EPOCHS     = 1
LR         = 2e-5
...
if __name__ == "__main__":
    print("=== Training ChatGPT Detector ===")

    ai_df    = pd.read_csv(os.path.join(DATA_DIR, "chatgpt", "samples.csv"))
